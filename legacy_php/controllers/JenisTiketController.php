...
class JenisTiketController
{
    ...
    public static function create(array $data)
    {
        ...
        if (!empty($wisata_id_input)) {
            ...
            if ($wisata_id_val && $wisata_id_val > 0) {
                ...
                if (class_exists('Wisata') && method_exists('Wisata', 'findById')) {
                    if (!Wisata::findById($wisata_id_val)) {
     ...
     */
    public static function getAllForAdmin(?string $searchTerm = null)
    {
        ...
        return JenisTiket::getAll($searchTerm);
    }
