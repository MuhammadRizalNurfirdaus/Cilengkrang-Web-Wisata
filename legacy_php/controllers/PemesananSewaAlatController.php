...
class PemesananSewaAlatController
{
     ...
     */
    public static function getAllPemesananSewaForAdmin(?string $searchTerm = null)
    {
        // Teruskan parameter pencarian ke Model
        $data = PemesananSewaAlat::getAll($searchTerm);
        return $data ?: []; // Selalu kembalikan array, bahkan jika Model mengembalikan false
    }
    /**
